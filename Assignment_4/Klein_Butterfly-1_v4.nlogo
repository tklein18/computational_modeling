...
globals [
  ...
  start_region_x_min ; the minimum x coordinate of the region that turtles start in
  start_region_y_min ; the minimum y coordinate of the region that turtles start in
  start_region_size ; added to the x and y min of the start region to determin max x and y coordinates
]
...
to setup
  ...
  ; setting the coordinates of the region that turtles start in
  ; both min values must be greater than or equal to 0, and less than the respective max coord of the map
  ; the min value + the size should be less than respective max coords of the map
  set start_region_x_min 60
  set start_region_y_min 60
  set start_region_size 30
  ...
  [
    set size 2
    ; set initial location to random within a region
    setxy start_region_x_min + (random-float 1.0 * start_region_size) start_region_y_min + (random-float 1.0 * start_region_size)
    pen-down
  ]
