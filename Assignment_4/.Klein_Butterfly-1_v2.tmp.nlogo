...
to setup
  ...
  ; both min values must be greater than or equal to 0, and less than 150
  ; the min value + the size should be less than 150
  set start_region_x_min 100
  set start_region_y_min 75
  set start_region_size 25
