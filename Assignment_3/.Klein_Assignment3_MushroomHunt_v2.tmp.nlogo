...
This model creates four clusters of mushrooms. It also generates one turtle, which moves randomly throughout the world seeking the mushrooms. When the turtle finds a mushroom, it consumes it, and continue moving. The mushrooms do not grow back.
...
One turtle is created at the start. It always begin in the center of the world, and faces a random direction. The turtle moves differently based on the amount of time since it found its last mushroom. If the turtle has found a mushroom within the last 20 time units, then at the beginning of the turn the turtle turns between -90 and 90 degrees and then moves forward 1 space. If the turtle has not found a mushroom within 20 turns, then it turns between -10 and 10 degrees before moving forward 1 space. 
